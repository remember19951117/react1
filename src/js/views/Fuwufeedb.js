...
class Fuwufeedb extends Component {
	state = {
		title: "",
		content: "",
		pageSize: 10000,
	...
	render() {
		...
		return (<div className="wrap">
			...
			<div className="GR_top">
				...
				<span className="GR_zc">{lang.nav224}</span>
			</div>
			...
			<div style={{ padding: "5%" }}>
				<textarea id="content" value={user.content} ref="content" placeholder="请输入您的问题反馈"
					style={{ background: "black", borderColor: '#03A1BA', width: "100%", height: "100px", color: "#03A1BA", paddingLeft: "5px" }}
				>
				</textarea>
			</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Fuwufeedb)
