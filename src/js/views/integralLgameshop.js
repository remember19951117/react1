...
class integralLgameshop extends Component {
		...
		return (
			...
			`}
				...
				<div className="GR_top">
					...
					<span className="GR_zc">游戏商城消费</span>
				</div>
...
integralLgameshop.contextTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(integralLgameshop)
